...
function Orders() {
	...
	return (
		<>
			<section className={` ${orders.length === 0 ? "h-full": "h-full py-1 bg-gray-100"}`}>
				<div className='w-full xl:w-8/12 mb-24 xl:mb-2 px-4 mx-auto mt-20'>
											...
											<table className='items-center bg-transparent w-full border-collapse '>
												...
												<tbody>
													{order.order.map((item, itemIndex) => (
														<tr key={itemIndex}>
															<th className='border-t-0 px-6 align-middle border-l-0 border-r-0 text-md whitespace-nowrap p-2 text-left text-blueGray-700'>
																{item.title}
															</th>
															<td className='border-t-0 px-6 align-middle border-l-0 border-r-0 text-md whitespace-nowrap p-2'>
																&#8377;{item.price.toLocaleString('en-IN')}
															</td>
															<td className='border-t-0 px-10 align-middle border-l-0 border-r-0 text-md whitespace-nowrap p-2'>
																{item.qty}
															</td>
															<td className='border-t-0 px-6 align-middle border-l-0 border-r-0 text-md whitespace-nowrap p-2'>
													...
													<tr className='border-t-2'>
														...
														<td
															className='border-t-0 px-6 align-middle border-l-0 border-r-0 text-md whitespace-nowrap p-2 font-bold '
															colSpan={2}>
															{order.date}
														</td>
